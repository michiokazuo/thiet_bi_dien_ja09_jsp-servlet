...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <a class="navbar-brand" href="trang-chu.tiles">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
            ...
            <li class="nav-item" id="san-pham">
                <a class="nav-link" href="san-pham.tiles">Quản lý sản phẩm </a>
            </li>
            <li class="nav-item" id="danh-muc">
                <a class="nav-link" href="danh-muc.tiles">Quản lý danh mục sản phẩm </a>
            </li>
            <li class="nav-item" id="dang-xuat">
